...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for git-town.
...
# NOTE: You might want to remove this if git-town is not hosted on GitHub releases.
